				...
				<tr>
					<td bgcolor="FFFFFF"  background="../../images/background.jpg" valign="top">
						<table border="0" cellpadding="1" cellspacing="1" bgColor=#cccccc>
							<font color="witel" size="2" face="Verdana, Arial, Helvetica"><b>DATA PROVISIONING FOR UPDATING DAMAN</b></font><br>
						...
						<tr class="head">
							...
							<td align="left" width="80" bgcolor="#FFC6C6"><b>STATUS PROV</b></td>
							<td align="left" width="80" bgcolor="#00ffff"><b>STATUS VALDAT</b></td>
							<td align="center" width="80" bgcolor="#00ffff"><b>UPDATE STATUS VALDAT</b></td>
							
							
							<td align="left" width="120" bgcolor="#ffff00"><b>CUST_NAME</b></td>
							<td align="left" width="80" bgcolor="#ffff00"><b>INST_ADDR</b></td>
							...
							<td align="left" width="120"><b>POWER_RECEIVE</b></td>
							...
							<td align="left" width="120"><b>NAMA_TECH</b></td>
						</tr>
...
?>
						...
						<tr class="isi">
							...
							<td align="center"><a href="status_valdat_modify.php?idx=<?php echo $aRow["idx"];?>"><img src="images/edit.gif" alt="" width="12" height="12" border="0"></a></td>
