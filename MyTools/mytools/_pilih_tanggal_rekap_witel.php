...
<form action="_data_mytools_rekap_witel.php" method="POST" name="inputan" onsubmit="return validasi()" enctype="multipart/form-data">
<table>	
<font face="Comic Sans MS"size="-1" color="black"><b>SELECT PERIODE TANGGAL</b></font>
