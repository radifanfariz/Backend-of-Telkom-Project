...
<?php
	...
	SELECT b.nama, a.witel, a.user_id2, COUNT(a.user_id2) as jumlah 
from t_sales_force a
LEFT JOIN t_user_mobile b
ON a.user_id2=b.userid
group BY a.witel, a.user_id2
				...
				<tr>
					<td align="center" bgcolor="FFFFFF"  background="../../images/background.jpg" valign="top">
						...
						<tr class="head">
							...
							<td align="left" width="80"><b>NAMA_TECH</b></td>
							<td align="left" width="80"><b>TECH_ID</b></td>
