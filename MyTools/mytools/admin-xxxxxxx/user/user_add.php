<?php
   ...
   $aSQL2 = "SELECT distinct(c_profile), l_profile  from p_profile";
...
<br>
<font color="#800000" size="4" face="Verdana, Arial, Helvetica"><b>Add User</b></font>
<br><br>
...
<table cellpadding="0" cellspacing="0" bgcolor="#ff00ff">
    ...
    <td>
		...
		?>
			<option value="<?php echo $aRow1['witel'];?>"><?php echo $aRow1['witel'];?>
		<?php
			}
		?>	
	</select>
...
<tr>
<td>UNIT</td><td><input type="text" name="unit" maxlength="6" size="6"></td>
</tr>
...
<tr>
<td>NIK</td><td><input type="text" name="nik" maxlength="50" size="30"></td>
</tr>
...
<td>HANDPHONE</td><td><input type="text" name="handphone" maxlength="50" size="30"></td>
    ...
    <td>
		...
		?>
			<option value="<?php echo $aRow2['c_profile'];?>"><?php echo $aRow2['c_profile'];?>
		<?php
			}
		?>	
	</select>
	...
	<tr><td>Password</td> <td><input type="Text" name="password" size="8" maxlength="16" readonly="yes" value="telkom2018"></td></tr>			
