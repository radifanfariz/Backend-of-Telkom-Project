...
<?php
  			...
  			if($_POST[confirm]=="yes")
				...
				include "../../connection/connection.php";  // untuk fungsi: "$db_host", "$db_login", "$db_password"
   				$aSQL = "UPDATE t_user_web_bges set nama='$_POST[nama]', userid='$_POST[userid]', unit='$_POST[unit]', c_profile ='$_POST[select_profile]', password ='$password', handphone='$_POST[handphone]', userid='$userid' where id=$_POST[id]";
				$aQResult=mysql_query($aSQL);
				}
			else
			    {
				include "../../connection/connection.php";  // untuk fungsi: "$db_host", "$db_login", "$db_password"
   				$aSQL = "UPDATE t_user_web_bges set nama='$_POST[nama]', userid='$_POST[userid]', unit='$_POST[unit]', c_profile ='$_POST[select_profile]', handphone='$_POST[handphone]', userid='$_POST[userid]' where id=$_POST[id]";
				$aQResult=mysql_query($aSQL);
				}
