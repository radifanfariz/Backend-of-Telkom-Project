...
<?php
	...
	$aSQL = "select * from t_hotnews order by tgl_jam desc limit 5";
	//$qry=mysqli_query($aSQL);
...
HOTNEWS<P>
  ...
  <tr>
	...
	<div class="thumbnail">
	<a href="../../pictures/<?php echo $row["pictures"];?> "><img src="../../pictures/<?php echo $row["pictures"];?>" width="150" height="120" alt="Please click here for large picture...!!!" /></a>
	</div>
	</td>
