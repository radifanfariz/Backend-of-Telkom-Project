<?php 
 ...
 $conn = mysqli_connect(HOST, USER, PASS, DB) or die ('Unable to Connect...');
     ...
     //$name = $_POST['name'];
     $idx = $_POST['idx'];															//MEDIUM SITOMPUL - 1
	$ket1 = $_POST['ket1a'];
	...
	// $barcode_port2 = $_POST['barcode_port2'];
	 ...
	 $alt_addr2 = $_POST['alt_addr2'];
	 $rad = $_POST['rad'];
	 $odo = $_POST['odo'];
	 $no_myir = $_POST['no_myir'];
	 $no_sc = $_POST['no_sc'];
	 $hp_alt = $_POST['hp_alt'];
    ...
    cust_addr='".$cust_addr2."',
    inst_addr='".$inst_addr2."',
    google_addr='".$google_addr2."', 
    hp='".$hp2."', 
    email='".$email2."', 
    packet_indihome='".$packet_indihome2."', 
    latitude_inst_addr='".$latitude_rmh2."', 
    longitude_inst_addr='".$longitude_rmh2."', 
    latitude_odp='".$latitude_odp2."', 
    longitude_odp='".$latitude_odp2."', 
    stp_name='".$stp_name."', 
    alt_addr='".$alt_addr2."',
    distance_rad='".$rad."',
    distance_odo='".$odo."',
