...
<?php
	include "connection/connection.php";  // untuk fungsi: "$db_host", "$db_login", "$db_password"
   	$aSQL = "SELECT * from t_datek_bgest";
...
<table align="center" border="0" cellpadding="0" cellspacing="1" bgcolor="#FFC68C" height="100%" width="240%">
...
<table border="0" cellpadding="1" cellspacing="1" bgColor=#cccccc>
	...
	<tr class="head">
		...
		<td align="left" width="200"><b>STP_PORT (UIM)</b></td>
