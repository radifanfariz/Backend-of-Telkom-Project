				...
				<tr>
					<td align="center" bgcolor="FFFFFF"  background="../../images/background.jpg" valign="top">
						<table border="0" cellpadding="1" cellspacing="1" bgColor=#cccccc>
							<font color="blue" size="2" face="Verdana, Arial, Helvetica"><b>CHECK DATA DOEBLE DI WITEL <?php echo $pilih_witel?></b><BR></font>
							...
							<td align="left" width="80"><b>CHECK UNIK_DOEBLE</b></td>
						</tr>
...
?>
						...
						<tr class="isi">
							...
							<td align="center"><a href="data_treg_selected.php?regional=<?php echo $aRow["regional"];?>"><?php print $aRow["jumlah"];?></a></td>
...
?>
  ...
  <tr bgcolor="#FFFF97">
	...
	<td align="center"><?php echo number_format (($total_jumlah),0,'.',",");?></td>
  </tr>
