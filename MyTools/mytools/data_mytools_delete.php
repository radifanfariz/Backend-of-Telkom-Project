...
<?php
	   ...
	   $barcode_port = $aRow["barcode_port"];
...
<h2>Delete Data MyTools</h2>



<form action="data_mytools_delete_process.php" method="POST">
   ...
   <tr><td bgcolor="lime"><font color="black"><b>21. QRcode_Port</b></font></td> <td>: <input type="Text" name="barcode_port" size="30" maxlength="16" readonly="yes" value="<?php echo $barcode_port;?>"></td></tr>
