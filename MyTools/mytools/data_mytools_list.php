...
<?php
	...
	order by timestamp desc, service_number desc
	";
...
<br>
<font color="blue" size="4" face="Verdana, Arial, Helvetica"><b>LIST COLLECTING DATA FROM MY-TOOLS WITEL <?php echo $pilih_witel?></b></font><br>
...
<table border="0" cellpadding="1" cellspacing="1" bgColor=#cccccc>
	<tr class="head">
		...
		<td align="CENTER" width="50"><b>STATUS_VALDAT</b></td>	
		...
		<td align="left" width="30"><b>FILENAME2</b></td>
		<td align="left" width="30"><b>FILENAME3</b></td>
...
?>
	...
	<td align="center"><a href="data_mytools_view.php?id=<?php echo $aRow["id"];?>"><img src="images/view1.jpg" alt="" width="24" height="24" border="0" title="View Data MyTools"></a></td>		
	<td align="center"><a href="data_mytools_update_status.php?id=<?php echo $aRow["id"];?>"><img src="images/edit.gif" alt="" width="24" height="24" border="0" title="Update Data MyTools"></a></td>	
    <td align="center"><a href="data_mytools_delete.php?id=<?php echo $aRow["id"];?>"><img src="images/delete.gif" alt="" width="24" height="24" border="0" title="Delete Data MyTools"></a></td>	
	
	<td align="left"><a href="data_mytools_update_status.php?id=<?php echo $aRow["id"];?>" title="Update Status Valdat"><?php print $aRow["status_valdat"];?></a></td>	
		...
		<td align="left"><?php print $aRow["filename2"];?></td>
		<td align="left"><?php print $aRow["filename3"];?></td>
		...
		<td align="center"><a href="image_view.php?url=<?php print $aRow["url"];?>">image_view</a></td>
