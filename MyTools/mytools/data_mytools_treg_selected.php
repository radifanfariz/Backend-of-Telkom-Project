...
<?php
	...
	include "connection/connection.php";  // untuk fungsi: "$db_host", "$db_login", "$db_password"
   	$aSQL = "SELECT regional, witel, count(witel) as jumlah from images where regional='$_GET[regional]'";
				...
				<tr>
					<td align="center" bgcolor="FFFFFF"  background="../../images/background.jpg" valign="top">
						<table border="0" cellpadding="1" cellspacing="1" bgColor=#cccccc>
							...
							<font color="#800000" size="2" face="Verdana, Arial, Helvetica"><b>AsDaProv WITEL</b></font>
							<br><br>
						<tr class="head">
							<td align="center" width="30"><b>NO</b></td>
							<td align="left" width="50"><b>REGIONAL</b></td>
...
?>
						...
						<tr class="isi">
							...
							<td align="right"><a href="data_mytools_witel_selected.php?regional=<?php echo $aRow["regional"];?>&witel=<?php echo $aRow["witel"];?>"><?php print $aRow["jumlah"];?></a></td>
