...
<?php
	include "connection/connection.php";  // untuk fungsi: "$db_host", "$db_login", "$db_password"
   	$aSQL2 = "SELECT distinct(status_valdat) from t_status_valdat";
...
<?php
	   ...
	   $status_valdat = $aRow["status_valdat"];	   	   
...
<h2>Update Data MyTools</h2>
- Cust_name <br>
- Cust_addr <br>
- Inst_addr <br>


<form action="data_mytools_update_status_process.php" method="POST">
   ...
   <tr><td bgcolor="lime">08. Custumer_name</td> <td>: <input type="Text" name="cust_name" size="30" maxlength="50" value="<?php echo $cust_name;?>"></td></tr>
   <tr><td bgcolor="lime">09. Customer_address	</td> <td>: <input type="Text" name="cust_addr" size="30" maxlength="250" value="<?php echo $cust_addr;?>"></td></tr>
   <tr><td bgcolor="lime">10. Installation_address</td> <td>: <input type="Text" name="inst_addr" size="30" maxlength="250" value="<?php echo $inst_addr;?>"></td></tr>
   ...
   <tr><td bgcolor="lime"><font color="black"><b>21. Status Valdat</b></font></td> <td>: <input type="Text" name="status_valdat" size="30" maxlength="16" readonly="yes" value="<?php echo $status_valdat;?>"></td></tr>
