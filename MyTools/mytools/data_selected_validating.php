<?php
	...
	include "connection/connection.php";  // untuk fungsi: "$db_host", "$db_login", "$db_password"
   	$aSQL = "SELECT * from t_datek_bgest where witel='$_GET[witel]' AND validating='$_GET[validating]'";
...
<table align="left" border="0" cellpadding="0" cellspacing="1" bgcolor="#FFC68C" height="100%" width="100%">
<tr><td align="left" bgcolor="FFFFFF"  background="../../images/background.jpg" valign="top">
...
<table border="0" cellpadding="1" cellspacing="1" bgColor=#cccccc style = "width:100%">
	...
	<tr class="head">
		...
		<td align="left" width="50"><b>NTE_DOWNLINK_PORT</b></td>
		
		<td align="left" width="50"><b>STP_TYPE</b></td>
		...
		<td align="left" width="50"><b>STP_PORT_UIM</b></td>
...
?>
	...
	<tr class="isi">
		<td align="center" title="Update dataid"><a href="data_update_.php?id=<?php echo $aRow["id"];?>"><?=$no;?></a></td>

		
		<td align="center"><font color="blue"><a href="data_view.php?id=<?php echo $aRow["id"];?>">View</a></font></td>
		<td align="center"><font color="#800000"><a href="data_update.php?id=<?php echo $aRow["id"];?>">Update</a></font></td>
		<td align="center"><font color="#800000"><a href="data_delete.php?id=<?php echo $aRow["id"];?>">Delete</a></font></td>
