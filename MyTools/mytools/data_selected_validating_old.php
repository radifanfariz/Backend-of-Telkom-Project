...
<?php
  	...
  	print "validating=".$_GET[validating]."<br>";
...
?>
	...
	<tr class="isi">
		<td align="center" title="Update dataid"><a href="data_update_.php?id=<?print $aRow["id"];?>"><?=$no;?></a></td>
		...
		<td align="left"><?print $aRow["nte_uplink_port"];?></td>
		
		<td align="left"><?print $aRow["stp_type_sn"];?></td>
		...
		<td align="left"><?print $aRow["stp_port_uim"];?></td>	
