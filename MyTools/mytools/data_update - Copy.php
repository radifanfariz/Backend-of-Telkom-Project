...
<?php
	   ...
	   $stp_port_uim = $stp_name ."-". $stp_panel ."-". $stp_port;
...
<!--    	<tr>
   ...
   <tr><td bgcolor="#FF8484">02. Serviceid</td> <td><input type="Text" name="serviceid" size="16" maxlength="50" readonly="yes" value="<?php echo $serviceid;?>"></td></tr>
