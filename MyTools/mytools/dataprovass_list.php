...
<table align="center" border="0" cellpadding="0" cellspacing="1" bgcolor="#FFC68C" height="100%" width="236%">
...
?>
	...
	<tr class="isi">
		...
		<td align="left"><?php print $aRow["latitude"];?></td>	
		<td align="left"><?php print $aRow["longitude"];?></td>	
