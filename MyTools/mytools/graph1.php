...
<?php
		...
		$strXML = "<chart caption='GRAPHIC DATA PRODUKTIVITAS TEKNISI WITEL $pilih_witel PERIODE TGL $pilih_tgl_awal S/D TGL $pilih_tgl_akhir' xAxisName='TANGGAL' yAxisName='JUMLAH DATA PROVISIONING YANG DICOLLECT DGN MYTOOLS'  showValues='1' decimals='1' formatNumberScale='0' chartRightMargin='50'>";  
