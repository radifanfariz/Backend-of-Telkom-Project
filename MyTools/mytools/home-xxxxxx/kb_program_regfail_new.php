...
<div class="container-fluid text-left">    
  ...
  <a href="../admin/project/regfail_sip_ont_offline/recovery_regfail_per_witel_rekap.php" target="tengah_bawah">10. New DASHBOARD PER WITELt</a></button>
  </div><br>  

  
    <div class="dropdown">
  <button class="dropbtn">11. Update Data Recovery Regfail</button>
  <div class="dropdown-content">
    <a href="../admin/project/regfail_sip_ont_offline/recovery_regfail_aceh.php" target="tengah_bawah">ACEH</a>
	<a href="../admin/project/regfail_sip_ont_offline/recovery_regfail_babel.php" target="tengah_bawah">BABEL</a>
	<a href="../admin/project/regfail_sip_ont_offline/recovery_regfail_bengkulu.php" target="tengah_bawah">BENGKULU</a>
	<a href="../admin/project/regfail_sip_ont_offline/recovery_regfail_jambi.php" target="tengah_bawah">JAMBI</a>
	<a href="../admin/project/regfail_sip_ont_offline/recovery_regfail_lampung.php" target="tengah_bawah">LAMPUNG</a>
	<a href="../admin/project/regfail_sip_ont_offline/recovery_regfail_medan.php" target="tengah_bawah">MEDAN</a>
	<a href="../admin/project/regfail_sip_ont_offline/recovery_regfail_ridar.php" target="tengah_bawah">RIDAR</a>
	<a href="../admin/project/regfail_sip_ont_offline/recovery_regfail_rikep.php" target="tengah_bawah">RIKEP</a>
	<a href="../admin/project/regfail_sip_ont_offline/recovery_regfail_sumbar.php" target="tengah_bawah">SUMBAR</a>
	<a href="../admin/project/regfail_sip_ont_offline/recovery_regfail_sumsel.php" target="tengah_bawah">SUMSEL</a>
	<a href="../admin/project/regfail_sip_ont_offline/recovery_regfail_sumut.php" target="tengah_bawah">SUMUT</a>
  </div>
</div> 
