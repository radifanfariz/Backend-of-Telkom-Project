	...
	<div class="login">
		<div class="login-form">
			...
			<input type="hidden" name="LogIn" value="yes">
				...
				<div><INPUT TYPE="Text" NAME="login" SIZE="10" MAXLENGTH="6" class="inputbox" value="651084"></div>
				<div class="inputlabel">Password</div>
				<div><INPUT TYPE="password" NAME="password" MAXLENGTH="20" class="inputbox" value="telkom"></div>
