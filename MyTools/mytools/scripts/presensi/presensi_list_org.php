...
?>
	...
	<tr class="isi">
		...
		<!---  --->
		<?if($aRow[tgl01]=='0'){?>
		<td align="center" bgcolor="green"><font color="white" title="xxx"><?=$aRow["tgl01"];?></font></a></td>
		<?}?>
		...
		<!---  --->
		<?if($aRow[tgl02]=='0'){?>
		<td align="center" bgcolor="green"><font color="white" title="xxx"><?=$aRow["tgl02"];?></font></a></td>
		<?}?>
		...
		<!---  --->
		<?if($aRow[tgl03]=='0'){?>
		<td align="center" bgcolor="green"><font color="white" title="xxx"><?=$aRow["tgl03"];?></font></a></td>
		<?}?>
		...
		<!---  --->
		<?if($aRow[tgl04]=='0'){?>
		<td align="center" bgcolor="green"><font color="white" title="xxx"><?=$aRow["tgl04"];?></font></a></td>
		<?}?>
		...
		<!---  --->
		<?if($aRow[tgl05]=='0'){?>
		<td align="center" bgcolor="green"><font color="white" title="xxx"><?=$aRow["tgl05"];?></font></a></td>
		<?}?>
		...
		<!---  --->
		<?if($aRow[tgl06]=='0'){?>
		<td align="center" bgcolor="green"><font color="white" title="xxx"><?=$aRow["tgl06"];?></font></a></td>
		<?}?>
		...
		<!---  --->
		<?if($aRow[tgl07]=='0'){?>
		<td align="center" bgcolor="green"><font color="white" title="xxx"><?=$aRow["tgl07"];?></font></a></td>
		<?}?>
		...
		<!---  --->
		<?if($aRow[tgl08]=='0'){?>
		<td align="center" bgcolor="green"><font color="white" title="xxx"><?=$aRow["tgl08"];?></font></a></td>
		<?}?>
		...
		<!---  --->
		<?if($aRow[tgl09]=='0'){?>
		<td align="center" bgcolor="green"><font color="white" title="xxx"><?=$aRow["tgl09"];?></font></a></td>
		<?}?>
		...
		<!---  --->
		<?if($aRow[tgl10]=='0'){?>
		<td align="center" bgcolor="green"><font color="white" title="xxx"><?=$aRow["tgl10"];?></font></a></td>
		<?}?>
		...
		<!---  --->
		<?if($aRow[tgl11]=='0'){?>
		<td align="center" bgcolor="green"><font color="white" title="xxx"><?=$aRow["tgl11"];?></font></a></td>
		<?}?>
		...
		<!---  --->
		<?if($aRow[tgl12]=='0'){?>
		<td align="center" bgcolor="green"><font color="white" title="xxx"><?=$aRow["tgl12"];?></font></a></td>
		<?}?>
		...
		<!---  --->
		<?if($aRow[tgl13]=='0'){?>
		<td align="center" bgcolor="green"><font color="white" title="xxx"><?=$aRow["tgl13"];?></font></a></td>
		<?}?>
		...
		<!---  --->
		<?if($aRow[tgl14]=='0'){?>
		<td align="center" bgcolor="green"><font color="white" title="xxx"><?=$aRow["tgl14"];?></font></a></td>
		<?}?>
		...
		<!---  --->
		<?if($aRow[tgl15]=='0'){?>
		<td align="center" bgcolor="green"><font color="white" title="xxx"><?=$aRow["tgl15"];?></font></a></td>
		<?}?>
		...
		<!---  --->
		<?if($aRow[tgl16]=='0'){?>
		<td align="center" bgcolor="green"><font color="white" title="xxx"><?=$aRow["tgl16"];?></font></a></td>
		<?}?>
		...
		<!---  --->
		<?if($aRow[tgl17]=='0'){?>
		<td align="center" bgcolor="green"><font color="white" title="xxx"><?=$aRow["tgl17"];?></font></a></td>
		<?}?>
		...
		<!---  --->
		<?if($aRow[tgl18]=='0'){?>
		<td align="center" bgcolor="green"><font color="white" title="xxx"><?=$aRow["tgl18"];?></font></a></td>
		<?}?>
		...
		<!---  --->
		<?if($aRow[tgl19]=='0'){?>
		<td align="center" bgcolor="green"><font color="white" title="xxx"><?=$aRow["tgl19"];?></font></a></td>
		<?}?>
		...
		<!---  --->
		<?if($aRow[tgl20]=='0'){?>
		<td align="center" bgcolor="green"><font color="white" title="xxx"><?=$aRow["tgl20"];?></font></a></td>
		<?}?>
		...
		<!---  --->
		<?if($aRow[tgl21]=='0'){?>
		<td align="center" bgcolor="green"><font color="white" title="xxx"><?=$aRow["tgl21"];?></font></a></td>
		<?}?>
		...
		<!---  --->
		<?if($aRow[tgl22]=='0'){?>
		<td align="center" bgcolor="green"><font color="white" title="xxx"><?=$aRow["tgl22"];?></font></a></td>
		<?}?>
		...
		<!---  --->
		<?if($aRow[tgl23]=='0'){?>
		<td align="center" bgcolor="green"><font color="white" title="xxx"><?=$aRow["tgl23"];?></font></a></td>
		<?}?>
		...
		<!---  --->
		<?if($aRow[tgl24]=='0'){?>
		<td align="center" bgcolor="green"><font color="white" title="xxx"><?=$aRow["tgl24"];?></font></a></td>
		<?}?>
		...
		<!---  --->
		<?if($aRow[tgl25]=='0'){?>
		<td align="center" bgcolor="green"><font color="white" title="xxx"><?=$aRow["tgl25"];?></font></a></td>
		<?}?>
		...
		<!---  --->
		<?if($aRow[tgl26]=='0'){?>
		<td align="center" bgcolor="green"><font color="white" title="xxx"><?=$aRow["tgl26"];?></font></a></td>
		<?}?>
		...
		<!---  --->
		<?if($aRow[tgl27]=='0'){?>
		<td align="center" bgcolor="green"><font color="white" title="xxx"><?=$aRow["tgl27"];?></font></a></td>
		<?}?>
		...
		<!---  --->
		<?if($aRow[tgl28]=='0'){?>
		<td align="center" bgcolor="green"><font color="white" title="xxx"><?=$aRow["tgl28"];?></font></a></td>
		<?}?>
		...
		<!---  --->
		<?if($aRow[tgl29]=='0'){?>
		<td align="center" bgcolor="green"><font color="white" title="xxx"><?=$aRow["tgl29"];?></font></a></td>
		<?}?>
		...
		<!---  --->
		<?if($aRow[tgl30]=='0'){?>
		<td align="center" bgcolor="green"><font color="white" title="xxx"><?=$aRow["tgl30"];?></font></a></td>
		<?}?>
		...
		<!---  --->
		<?if($aRow[tgl31]=='0'){?>
		<td align="center" bgcolor="green"><font color="white" title="xxx"><?=$aRow["tgl31"];?></font></a></td>
		<?}?>
