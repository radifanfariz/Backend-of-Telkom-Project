...
$target_path = $_SERVER["DOCUMENT_ROOT"]."/webbasic/scripts/upload_csvfile_database_append/temporary_files/";
...
<script javascript="JavaScript">
		...
		location.href="uploadfile_client_databaseserver_append_3.php";
